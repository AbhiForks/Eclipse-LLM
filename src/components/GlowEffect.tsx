...
const GlowEffect: FC<GlowEffectProps> = ({ 
  ...
  return (
    <div className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`}>
      ...
      <motion.div
        initial={{ opacity: opacityValues.min * 0.7, scale: scaleValues.min * 0.8 }}
        animate={{ 
          opacity: [opacityValues.min * 0.7, opacityValues.max * 0.7, opacityValues.min * 0.7],
          scale: [scaleValues.min * 0.8, scaleValues.max * 0.8, scaleValues.min * 0.8],
      ...
      <motion.div
        initial={{ opacity: opacityValues.min * 0.6, scale: scaleValues.min * 0.7 }}
        animate={{ 
          opacity: [opacityValues.min * 0.6, opacityValues.max * 0.6, opacityValues.min * 0.6],
          scale: [scaleValues.min * 0.7, scaleValues.max * 0.7, scaleValues.min * 0.7],
